...
![image-20211107201601953](README.assets/image-20211107201601953.png)

Linux参看IP地址的配置命令：nmcli、IP add ，ifconfig（centos7基本使用nmcli，需要的话自己再安装i服从fig的网络插件）。。。

![image-20211107202225187](README.assets/image-20211107202225187.png)
...
![image-20211107202840656](README.assets/image-20211107202840656.png)
...
![image-20211107203956597](README.assets/image-20211107203956597.png)
...
![image-20211107210952169](README.assets/image-20211107210952169.png)

Windows主机ping虚拟机IP地址：

![image-20211107211124298](README.assets/image-20211107211124298.png)
...
进入Xshell[官网下载](https://www.netsarang.com/zh/free-for-home-school/)，我们可以填写学生信息免费使用，在这里也准备了[Xftp-7.0.0088p](codefile/Xftp-7.0.0088p.exe)（上传文件）版本和[Xshell-7.0.0090p](codefile/Xshell-7.0.0090p.exe)（远程登录）

下载安装，打开Xshell，配置远程访问

![image-20211108112741348](README.assets/image-20211108112741348.png)
